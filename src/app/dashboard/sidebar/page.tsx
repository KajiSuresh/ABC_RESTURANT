      ...
      <nav className="flex flex-col items-center gap-4 px-2 sm:py-5">
        <TooltipProvider>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Link
                href="/dashboard/layout/dinnings"
                className="flex h-9 w-9 items-center justify-center rounded-lg bg-accent text-accent-foreground transition-colors hover:text-foreground md:h-8 md:w-8"
                prefetch={false}
              >
                <View className="h-5 w-5" />
                <span className="sr-only">Dinning</span>
              </Link>
            </TooltipTrigger>
            <TooltipContent side="right">Dinning</TooltipContent>
          </Tooltip>
          <Tooltip>
            <TooltipTrigger asChild>
              <Link
                href="/dashboard/layout/reservations"
                className="flex h-9 w-9 items-center justify-center rounded-lg bg-accent text-accent-foreground transition-colors hover:text-foreground md:h-8 md:w-8"
                prefetch={false}
              >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Link
                href="/dashboard/layout/contacts"
                className="flex h-9 w-9 items-center justify-center rounded-lg bg-accent text-accent-foreground transition-colors hover:text-foreground md:h-8 md:w-8"
                prefetch={false}
              >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Link
                href="/dashboard/layout/services"
                className="flex h-9 w-9 items-center justify-center rounded-lg bg-accent text-accent-foreground transition-colors hover:text-foreground md:h-8 md:w-8"
                prefetch={false}
              >
